...
>
> https://github.com/91fabu/v2rayN-noADG
...
Minimum OS requirements: [Release files introduction](https://github.com/91fabu/v2rayN-noAD/wiki/Release-files-introduction) / 最低系统要求：[发布文件介绍](https://github.com/91fabu/v2rayN-noAD/wiki/Release-files-introduction)
